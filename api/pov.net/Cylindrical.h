...
namespace povclr
{
	public ref class Cylindrical : public Pattern, public ITargetType<Pigment^>, public ITargetType<Normal^>, public ITargetType<Texture^>
	{
	internal:
		...
		void Render(Context^ context, PatternType* container)
		{
			...
			auto pat = new pov::CylindricalPattern();
