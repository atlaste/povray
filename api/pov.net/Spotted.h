...
namespace povray
{
	namespace Materials
	{
		namespace Patterns
		{
			public ref class Spotted : public Pattern, public ITargetType<Pigment^>, public ITargetType<Normal^>, public ITargetType<Texture^>
			{
			internal:
				...
				void Render(Context^ context, PatternType* container)
				{
					...
					auto pat = new pov::SpottedPattern();
