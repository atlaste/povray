...
namespace povray
{
	namespace Materials
	{
		namespace Patterns
		{
			...
			template<>
			pov::GenericPigmentBlendMapPtr ColorMapDetail::Render<pov::GenericPigmentBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
				return ColorMapDetail::Render<pov::ColourBlendMap>(context, tempList, blendMode, blendGamma);
			}

			template<>
			pov::PigmentBlendMapPtr ColorMapDetail::Render<pov::PigmentBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
			...
			template<>
			std::shared_ptr<pov::GenericNormalBlendMap> ColorMapDetail::Render<pov::GenericNormalBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
				context->Error("Internal Error: Parse_Colour_Map called for non-colour blend map");
			...
			template<>
			pov::SlopeBlendMapPtr ColorMapDetail::Render<pov::SlopeBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
				context->Error("Internal Error: Parse_Colour_Map called for non-colour blend map");
			...
			template<>
			pov::NormalBlendMapPtr ColorMapDetail::Render<pov::NormalBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
				context->Error("Internal Error: Parse_Colour_Map called for non-colour blend map");
			...
			template<>
			pov::TextureBlendMapPtr ColorMapDetail::Render<pov::TextureBlendMap>(gcroot<Context^> context, std::vector<pov::ColourBlendMapEntry>& tempList, int blendMode, float blendGamma)
			{
				context->Error("Internal Error: Parse_Colour_Map called for non-colour blend map");
