...
namespace povray
{
	public ref class Granite : public Pattern, public ITargetType<Pigment^>, public ITargetType<Normal^>, public ITargetType<Texture^>
	{
	internal:
		...
		void Render(Context^ context, PatternType* container)
		{
			...
			auto pat = new pov::GranitePattern();
